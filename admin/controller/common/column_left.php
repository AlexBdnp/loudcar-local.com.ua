		...
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/product')) {
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sort_order&order=ASC', true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/manufacturer')) {
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/manufacturer', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order&order=ASC', true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/attribute')) {
				$attribute[] = array(
					...
					'href'     => $this->url->link('catalog/attribute', 'user_token=' . $this->session->data['user_token'] . '&sort=a.sort_order&order=ASC', true),
					'children' => array()	
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/attribute_group')) {
				$attribute[] = array(
					...
					'href'     => $this->url->link('catalog/attribute_group', 'user_token=' . $this->session->data['user_token'] . '&sort=ag.sort_order&order=ASC', true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/filter')) {
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/filter', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order&order=ASC', true),
					'children' => array()		
				);
			}
