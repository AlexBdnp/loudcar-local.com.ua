    ...
    e.extend(t.prototype, {
        ...
        _attachSelectbox: function(s, t) {
            function l() {
                ...
                for (s in b._state)
                    s !== a && b._state.hasOwnProperty(s) && (t = e("select[sb='" + s + "']")[0],
                    t && b._closeSelectbox(t))
            }
            function o() {
                ...
                arguments[0].each(function(i) {
                    ...
                    o.is(":selected") && (d.text(o.text()),
                    f = n),
                    i === _ - 1 && c.addClass("last"),
                    o.is(":disabled") || a ? (l = e("<span>", {
                        text: o.text()
                    }).addClass(g.settings.classDisabled),
                    t && l.addClass(g.settings.classSub),
                    l.appendTo(c)) : (l = e("<a>", {
                        href: "#" + o.val(),
                        rel: o.val()
                        ...
                        b._changeSelectbox(s, i.attr("rel"), i.text()),
                        b._closeSelectbox(s)
                    }).bind("mouseover.sb", function() {
                        var s = e(this);
                        s.parent().siblings().find("a").removeClass(g.settings.classFocus),
                        s.addClass(g.settings.classFocus)
                    }).bind("mouseout.sb", function() {
                        e(this).removeClass(g.settings.classFocus)
                    }),
                    t && l.addClass(g.settings.classSub),
                    o.is(":selected") && l.addClass(g.settings.classFocus),
                    l.appendTo(c)),
                    c.appendTo(u)
                })
            }
            if (this._getInst(s))
                return i;
            var c, d, r, u, p = e(s), b = this, g = b._newInst(p), f = i, h = (p.find("optgroup"),
            p.find("option")), _ = h.length;
            p.attr("sb", g.uid),
            e.extend(g.settings, b._defaults, t),
            b._state[g.uid] = i,
            p.hide(),
            c = e("<div>", {
                id: "sbHolder_" + g.uid,
            ...
            p.children().each(function() {
                var s, t = e(this), a = {};
                t.is("option") ? o(t) : t.is("optgroup") && (s = e("<li>"),
                e("<span>", {
                    text: t.attr("label")
                }).addClass(g.settings.classGroup).appendTo(s),
                s.appendTo(u),
                t.is(":disabled") && (a.disabled = !0),
                a.sub = !0,
                o(t.find("option"), a))
            }),
            f || d.text(h.first().text()),
            e.data(s, a, g),
            c.data("uid", g.uid).bind("keydown.sb", function(s) {
                ...
                case 38:
                    if (c.length > 0) {
                        var d;
                        e("a", i).removeClass(l.settings.classFocus),
                        d = c.parent().prevAll("li:has(a)").eq(0).find("a"),
                        d.length > 0 && (d.addClass(l.settings.classFocus).focus(),
                        e("#sbSelector_" + n).text(d.text()))
                    }
                    break;
                case 39:
                case 40:
                    var d;
                    e("a", i).removeClass(l.settings.classFocus),
                    d = c.length > 0 ? c.parent().nextAll("li:has(a)").eq(0).find("a") : i.find("ul").find("a").eq(0),
                    d.length > 0 && (d.addClass(l.settings.classFocus).focus(),
                    e("#sbSelector_" + n).text(d.text()));
                    break;
                case 13:
                    c.length > 0 && b._changeSelectbox(o, c.attr("rel"), c.text()),
                    b._closeSelectbox(o);
                    break;
                case 9:
                    if (o) {
                        var l = b._getInst(o);
                        l && (c.length > 0 && b._changeSelectbox(o, c.attr("rel"), c.text()),
                        b._closeSelectbox(o))
                    }
            ...
            u.appendTo(c),
            c.insertBefore(p),
            e("html").on("mousedown", function(s) {
                s.stopPropagation(),
        ...
        _detachSelectbox: function(s) {
            ...
            return t ? (e("#sbHolder_" + t.uid).remove(),
            e.data(s, a, null),
            void e(s).show()) : i
        },
        _changeSelectbox: function(s, t, a) {
            var i, l = this._getInst(s);
            l && (i = this._get(l, "onChange"),
            e("#sbSelector_" + l.uid).text(a)),
            t = t.replace(/\'/g, "\\'"),
            e(s).find("option[value='" + t + "']").prop("selected", n),
            l && i ? i.apply(l.input ? l.input[0] : null, [t, l]) : l && l.input && l.input.trigger("change")
        },
        _enableSelectbox: function(s) {
            var t = this._getInst(s);
            return t && t.isDisabled ? (e("#sbHolder_" + t.uid).removeClass(t.settings.classHolderDisabled),
            t.isDisabled = i,
            void e.data(s, a, t)) : i
        },
        _disableSelectbox: function(s) {
            var t = this._getInst(s);
            return !t || t.isDisabled ? i : (e("#sbHolder_" + t.uid).addClass(t.settings.classHolderDisabled),
            t.isDisabled = n,
            void e.data(s, a, t))
        },
        ...
        _openSelectbox: function(s) {
            ...
            if (t && !t.isOpen && !t.isDisabled) {
                ...
                200 > r ? (r = o.top - c - (e("#stuck").outerHeight() + 10),
                i.css({
                    top: "auto",
                    bottom: d + "px",
                    maxHeight: r + "px"
                ...
                "fade" === t.settings.effect ? i.fadeIn(t.settings.speed) : i.slideDown(t.settings.speed),
                e("#sbToggle_" + t.uid).addClass(t.settings.classToggleOpen),
                this._state[t.uid] = n,
                t.isOpen = n,
                u && u.apply(t.input ? t.input[0] : null, [t]),
                e.data(s, a, t)
            }
        },
        _closeSelectbox: function(s) {
            ...
            if (t && t.isOpen) {
                ...
                "fade" === t.settings.effect ? e("#sbOptions_" + t.uid).fadeOut(t.settings.speed) : e("#sbOptions_" + t.uid).slideUp(t.settings.speed),
                e("#sbToggle_" + t.uid).removeClass(t.settings.classToggleOpen),
                this._state[t.uid] = i,
                t.isOpen = i,
                n && n.apply(t.input ? t.input[0] : null, [t]),
                e.data(s, a, t)
            }
        },
        _newInst: function(e) {
